...
<body class="body">
    ...
    <div class="abt">
        ...
        <div class="row">
            ...
            <div class="column">
                <div class="card">
                    <img src="../img/img_avatar1.jpg" alt="Jane">
                    <div class="container">
                        <h4>UTSAV MODI</h4>
                        <p class="title">PROJECT MEMBER</p>
                        <p>-Manages the whole project and design the more interactive front-end with project members.</p>
                        <p class="title mb-1">E-mail: </p>
                        <p>utsavmodi000@gmail.com</p>
            ...
            <div class="column">
                <div class="card">
                    <img src="../img/img_avatar2.jpg" alt="John">
                    <div class="container">
                        <h4>HARSHIL AMIN</h4>
                        <p class="title">PROJECT MEMBER</p>
                        <p>-He also design front-end and provide the back-end support to the project leader</p>
                        <p class="title mb-1">E-mail: </p>
                        <p>aminharshil665@gmail.com</p>
                        <!-- <p><button class="button">Contact</button></p> -->
                    </div>
                </div>
            </div>
